...
Fisicas::Fisicas(float posX_, float posY_, float velX_, float velY_, float masa_, float radio_, float K_, float F_, float G)
{
    PX = posX_; //pos en x
    PY = posY_; //pos en y
    mass = masa_; // masa del cuerpo
...
{
    /* Formulas fisicas a implementar en los objetos */
